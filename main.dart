...
//class VideoTheoryPage extends StatefulWidget {
//  const VideoTheoryPage({super.key});

  //@override
  // ignore: library_private_types_in_public_api
  //_VideoTheoryPageState createState() => _VideoTheoryPageState();
  
//}

//class _VideoTheoryPageState extends State<VideoTheoryPage> {
  ...
  //Widget build(BuildContext context) {
   ...
   //   appBar: AppBar(
    ...
    //  body: Center(
      //  child: ElevatedButton(
        //  onPressed: () => _launchURL('https://www.youtube.com/watch?v=Yx1kE6WPONA'),
          //child: const Text(
            //'Смотреть',
            //style: TextStyle( 
              //fontSize: 24.0, // Крупный размер текста 
              //fontWeight: FontWeight.bold,),
        //),
      //),
    //)
